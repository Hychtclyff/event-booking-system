      ...
      >
        ...
        <div className="flex flex-col h-full justify-between gap-6 ">
          <button
            ...
            className="px-8 py-2 rounded-full relative z-10 bg-slate-700 text-white text-sm hover:shadow-2xl hover:shadow-white/[0.1] transition duration-200 border border-slate-600"
          >
